...
<body>
	...
	<div id="raya"></div>
		...
		<div class="container-fluid">
			<div class="row">
				<h3>Buscar Tipo de Bicicleta</h3>
				<hr>
				<div class="col-md-2"></div>
				<div class="col-md-6">
					<form class="form-horizontal">
					  <div class="form-group">
					    <label for="idTipoBici" class="col-sm-3 control-label">Identificador</label>
					    <div class="col-sm-4">
					      <input id="txt-idTipoBici" name="tipoBici" type="text" class="form-control" placeholder="Identificador">
					    </div>
					    <button class="btn btn-default" id="btn-bucar-tipobici"><li class="glyphicon glyphicon-search"></li></button>
					  </div>
					  </br>
					...
					<form class="form-horizontal mostrar-resultado-tipo">
					
					  <div class="form-group">
					    <label for="tipo" class="col-sm-3 control-label">Tipo Bicicleta</label>
					    <div class="col-sm-8">
					      <input id="txt-tipoBici" name="tipoBici" type="text" class="form-control" disabled="disabled">
					    </div>
					  </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-8">
					      <textarea id="txt-descripcion" class="form-control" rows="4" disabled="disabled"></textarea>
					    </div>
					  </div>
		   ...
		   <div class="row">
		   		<div class="col-md-2"></div>
		   		<dir class="col-md-8">
		   			<div class="alert alert-warning mostrar-resultado-tipo" role="alert">
		   				<b>NOTA: </b>
		   				<span>Aqu&iacute; solo podr&aacute; consultar informaci&oacute; que necesite para tomar notas o verificar datos de un tipo de bicicleta en particular. No tiene permitido 
