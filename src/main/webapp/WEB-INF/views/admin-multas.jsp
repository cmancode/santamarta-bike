				...
				<div class="col-md-6">
					...
					<form class="form-horizontal quitar-mostrar-resultado-tipo">
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-8">
					      <input id="txt-tipoBici" name="tipoBici" type="text" class="form-control" >
					    </div>
					  </div>
					  ...
					  <div class="form-group">
					    <div class="col-sm-offset-2 col-sm-10" id="container-guardar-bici">
					      <button type="submit" id="guardar-bici" class="btn btn-default btn-action-bici"><span class="glyphicon glyphicon-floppy-saved"></span> Actualizar Registro</button>
					    </div>
					  </div>
